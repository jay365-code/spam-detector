...
// 백엔드 constants.py 및 spam_guide_20230724.md 기준 (0-3 코드 체계)
const CLASSIFICATION_MAP: Record<string, string> = {
  "0": "기타 (통신, 대리운전, 구인/구직, 성인/도박/금융 외 기타 스팸)",
  "1": "성인 (유흥업소, 룸싸롱, 성인만남, 성매매 등)",
  "2": "도박 (카지노, 바카라, 사다리, 불법 토토 등)",
  "3": "금융 (불법 대출, 피싱, 주식 리딩방, 코인 사기 등)",
  "30": "판단 보류 (HITL)",
  "HAM-1": "응답/알림/명세서",
  "HAM-2": "명확한 사업자 광고",
  "HAM-3": "생활 밀착형 정보/기타",
