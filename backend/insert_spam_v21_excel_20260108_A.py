...
EXCEL_PATH = r"d:\Projects\spam-detector\spams\MMSC스팸추출_20260108_A.xlsx"
...
def insert_v21():
    ...
    try:
        try:
            ...
            print(f"[{SHEET_NAME}] 시트가 없습니다. 첫 번째 기본 시트를 로드합니다.")
        ...
        with sqlite3.connect(DB_PATH) as conn:
            ...
            print(f"=== 20260108_A 파일 DB 업데이트 시작 (타겟: {len(unique_raw_texts)}건) ===")
            ...
            conn.commit()
        print(f"\n작업 완료! 정상 적용된 텍스트 수: {success_count}건")
