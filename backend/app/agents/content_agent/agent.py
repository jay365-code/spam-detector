...
4. 정치/선거 캠페인 예외: 공직선거법에 따른 선거 운동, 정당 홍보, 출마 후보자 안내 등의 정치적 메시지는 (광고) 표기나 080 수신거부 번호가 없더라도 합법적인 면제 대상이다. 따라서 메시지 내용이 선거/후보자 홍보나 정치적 안부 인사라면 정통망법 미준수(광고 표기 누락 등)를 이유로 SPAM 판정하지 말고 반드시 안전한 HAM으로 판정하라.
