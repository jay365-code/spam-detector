...
LLM_MODELS = {
    "GEMINI": [
        ...
        {"name": "Gemini 3.1 Flash-Lite (Preview)", "id": "gemini-3.1-pro-preview"},
    ],
    "OPENAI": [
...
CONFIG_METADATA = [
    ...
    {"key": "LLM_SUB_MODEL", "label": "예비 분석 모델(타임아웃 시)", "description": "응답 지연 시 전환할 가장 정확한 예비 모델", "type": "select", "options": ["gemini-3.1-pro-preview", "gemini-2.5-flash"]},
