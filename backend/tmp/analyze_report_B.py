...
file_path = "c:/Users/leejo/Project/AI Agent/Spam Detector/data/reports/report-20260326_B.json"
...
for log in logs:
    ...
    # Check Type B Overrides (where learning_label is HAM but original is_spam was true, or FP Sentinel took action)
    ...
    # Collect some interesting samples (e.g. Obfuscated domains)
    if urls and is_spam and len(stats["interesting_cases"]) < 5:
...
print(f"Type B Overrides (Protected): {stats['type_b_overrides']}")
