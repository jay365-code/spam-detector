...
for idx, m in h['메시지'].items():
    if '영종국제도시' in str(m) and '대단지' in str(m):
...
with open(r'c:\Users\leejo\Project\AI Agent\Spam Detector\tmp\diff_result3.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output))

print("Done. Saved to diff_result3.txt")
