...
def norm(text):
    ...
    text = re.sub(r'^(\W*(web발신|웹발신|국제발신|로밍발신|광고)\W*)+', '', text, flags=re.IGNORECASE)
...
with open(r'c:\Users\leejo\Project\AI Agent\Spam Detector\tmp\diff_result5.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output))

print("Done. Saved to diff_result5.txt")
